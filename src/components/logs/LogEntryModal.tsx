                ...
                {feedingType === 'breast' ? (
                  <div className="space-y-4">
                    ...
                    <button
                      ...
                      className="w-full px-4 py-3 bg-gradient-to-r from-blue-500 to-pink-500 text-white rounded-xl font-medium hover:from-blue-600 hover:to-pink-600 transition-all shadow-lg flex items-center justify-center gap-2"
                    >
                      ⏱️ タイマーを使う
                    </button>
